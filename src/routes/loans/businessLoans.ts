...
export const businessLoanRouter = express.Router()

businessLoanRouter.post('/',async(req,res)=>{
...
businessLoanRouter.post('/verify',async(req,res)=>{
    const userId = res.locals.userId as string
...
businessLoanRouter.post('/otp-regenerate',async(req,res)=>{
    try {
        const userId = res.locals.userId as string
